...
public class CommonElementsTest  {
    ...
    public void testCommonHappy(){
        assertArrayContentsEqual(createList(new int[]{1}),
                commonElementsInArray
                        .getCommonElements(createList(new int[]{1, 2, 3}), createList(new int[]{4, 1, 5})));
    }
    ...
    public void testAllMatch(){
        assertArrayContentsEqual(createList(new int[]{3, 4, 5, 6}), commonElementsInArray.getCommonElements(createList(new int[]{
            6, 5, 4, 3
    ...
    public void testDifferentLengths(){
        assertArrayContentsEqual(createList(new int[]{3, 4, 5, 6}), commonElementsInArray
                .getCommonElements(createList(new int[]{
            6, 5, 4, 3, 50}),createList(new int[]{3, 4, 5, 6, 20, 21,22,23})));
    }
    ...
    public void testNoDuplicatesInOutput(){
        assertArrayContentsEqual(createList(new int[]{3, 4, 5, 6}), commonElementsInArray
                .getCommonElements(createList(new int[]{
            6, 5, 6, 6, 4, 3, 3, 50}),createList(new int[]{3, 4, 5, 6, 20, 4, 21,22,23})));
    }
